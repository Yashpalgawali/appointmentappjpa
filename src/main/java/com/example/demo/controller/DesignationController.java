...
public class DesignationController {
	...
	public ResponseEntity<ResponseDto> createDesignation(@Valid @RequestBody Designation designation) {
		...
		return ResponseEntity.status(HttpStatus.CREATED).body(new ResponseDto(designation.getDesignationName()+" is created successfully",HttpStatus.CREATED.toString()));
	}
	...
	public ResponseEntity<ResponseDto> updateDesignation(@Valid @RequestBody Designation designation) {
		...
		return ResponseEntity.status(HttpStatus.CREATED).body(new ResponseDto(designation.getDesignationName()+" is updated successfully",HttpStatus.CREATED.toString()));
	}
